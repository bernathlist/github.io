...
TheRow = '<li>' + shoppinglist[i] + btndelete + ''</li>'; 
TheList += TheRow;
}
//v3.1 add Title
if (arrayLength > 0)
...
arrays = "'"+arrays+"'";
//v 3.1 add edit button using below i index & name it btnpdate
var btnaddlist =  '<label><input name="add" type="x" id="adds" value="Add to Shopping List" onclick="addbacktoshoppinglist('+arrays+',' + i + ')" checked="checked"/>Add</label>';
